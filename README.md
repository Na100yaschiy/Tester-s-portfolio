...
*Skyeng — это онлайн-школа английского языка, которая помогает людям, поставившим перед собой конкретные жизненные цели, достичь их в процессе обучения. Мы ставим перед собой задачу — сделать обучение максимально удобным и эффективным, интересным и увлекательным. Для того чтобы реализовать все наши задумки, мы собрали вместе яркую команду, в которой каждый участник делает свой важный вклад в развитие школы. На текущий момент мы разрабатываем крутейшее в мире решение для онлайн-преподавания английского языка один на один с учителем, являемся самой крупной языковой онлайн-школой в Восточной Европе и быстро развиваемся.*

В структурный элемент **календарь** веб-приложения для учителей добавлен новый элемент — **личные события**, который необходимо протестировать. Преподаватель может использовать личные события для собственных встреч. Они служат напоминанием, что у преподавателя что-то запланировано на это время.\
*С личными событиями можно проводить следующие манипуляции:*
- Добавлять личные события.
- Удалять личные события. 
- Редактировать личные события.
- Совмещать личное событе и урок.
...
- расставлять приоритеты среди множества задач;
- анализировать и усваивать большой объем информации;
- укладываться в дедлайн;
- искать и находить нужную и недостающую информации в интернете;
...
**Чему я научился:**
- навыкам тайм-менеджмента в условиях жесткой нехватки свободного времени;
- учиться на чужих ошибках;
- подсматривать за более опытными коллегами и перенимать их опыт.

### Проект № 3: тестирование мобильного приложения Skyeng для изучения английского языка.
*Skyeng — это онлайн-школа английского языка, которая помогает людям, поставившим перед собой конкретные жизненные цели, достичь их в процессе обучения. Мы ставим перед собой задачу — сделать обучение максимально удобным и эффективным, интересным и увлекательным. Для того чтобы реализовать все наши задумки, мы собрали вместе яркую команду, в которой каждый участник делает свой важный вклад в развитие школы. На текущий момент мы разрабатываем крутейшее в мире решение для онлайн-преподавания английского языка один на один с учителем, являемся самой крупной языковой онлайн-школой в Восточной Европе и быстро развиваемся.*

Мобильное приложение содержит следующие разделы, которые необходимо протестировать:
- Раздел «Ситуации» содержит в себе **ситуации**, которые состоят из различных уроков, благодаря которым ученик сможет получать практические навыки.
- Раздел «Видеопрактика» содержит в себе каталог видео на английском языке на различные темы, благодаря которому ученик сможет изучать новые для себя слова и добавлять их в свой словарь.
...
- быть лидером в ситуации, когда лидерство воспринимается как обуза;
- ответственному отношению к своей роли в команде;
- идти на компромисс.

### Проект № 4: тестирование веб-приложения для учителей от Skyeng.
*Skyeng — это онлайн-школа английского языка, которая помогает людям, поставившим перед собой конкретные жизненные цели, достичь их в процессе обучения. Мы ставим перед собой задачу — сделать обучение максимально удобным и эффективным, интересным и увлекательным. Для того чтобы реализовать все наши задумки, мы собрали вместе яркую команду, в которой каждый участник делает свой важный вклад в развитие школы. На текущий момент мы разрабатываем крутейшее в мире решение для онлайн-преподавания английского языка один на один с учителем, являемся самой крупной языковой онлайн-школой в Восточной Европе и быстро развиваемся.*\

**Преподаватель** использует веб-приложение, а **ученик** мобильное приложение, для того чтобы вместе войти в одну веб-комнату для проведения онлайн-урока. Необходимо протестировать общий для преподавателя и ученика функционал **Видеопрактика**, который используется во время онлайн-урока для взаимодействия между ними.
...
- самостоятельности;
- самодисциплине;
- умению находить выход из сложной ситуации;
- принимать решения, прямо или косвенно влияющие на результат моего труда;
- самомотивации;
- делать выбор между тем, что нужно сделать и тем, что хочется сделать.
